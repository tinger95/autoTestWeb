        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='maincontent' ID="caseCommentContainer">
                    <lable>Case描述</lable>
                    <textarea id="txtCaseComment" style="width:300px;height:45px;" maxLength="255"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="addCase();" id="btnAddCase">
                    确定
                </button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="updateCase();"
                        id="btnUpdateCase">确定
                </button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="copyCase();"
                        id="btnCopyCase">确定
                </button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="copyCheckCase();"
                        id="btnCopyCheckCase">确定
                </button>
...
<div class="modal fade" id="caseExecuteConditionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="confirmExecute();"
                        id="btnConfirmExecute">确定
                </button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
...
<div class="modal fade" id="caseStrategyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="confirmStrategy();"
                        id="btnAddStrategy">确定
                </button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
